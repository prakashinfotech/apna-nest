...
1. Submit a [private GitHub security advisory](https://github.com/prakashinfotech/apna-nest/security/advisories/new), if private vulnerability reporting is enabled.
2. Otherwise, email [info@prakashinfotech.com](mailto:info@prakashinfotech.com) with the subject **ApnaNest Security Report**.
